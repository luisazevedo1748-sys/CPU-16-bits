...
- Opening this block from the repo: add
  `registers/register_16bits/register_4bits/` and the folders below it as custom
  component search paths, because Digital only searches sub-directories of the
  file it opens.
