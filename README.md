...
└─ mult_cell_4_bits/ ── mult_cell_1_bit/   combinational array-multiplier cell (in progress)
```
...
| Multiply/divide unit (MDU) | In progress (16-bit multiplier and divider missing) |
| ALU | Not started |
